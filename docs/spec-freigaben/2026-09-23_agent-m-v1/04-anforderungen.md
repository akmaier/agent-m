...
**A REQUIREMENT HAS FIVE FIELDS** *(SOFTWARE_MAINTENANCE.md, "Wie eine Anforderung aussieht")*
...
**ONE STATEMENT PER REQUIREMENT** *(SOFTWARE_MAINTENANCE.md, same section)*
...
**A RULE IS CHECKABLE** *(SOFTWARE_MAINTENANCE.md, same section)*
...
**NO STATE IN THE SPECIFICATION** *(PO A. Maier, 2026-08-26, carried over)*
...
**A REQUIREMENT IS NOT CHANGED WITHOUT AN IMPACT LIST** *(SOFTWARE_MAINTENANCE.md, "Auswirkungsanalyse")*
