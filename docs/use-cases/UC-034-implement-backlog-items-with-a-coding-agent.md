...
failing tests first, then the implementation, and opens a pull request that is merged on green CI.
...
8. With CI green and no gate left, the pull request is merged. The item counts as done. For an item
